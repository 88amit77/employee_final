...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TestingNames',
            fields=[
                ('tn_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ts_startfile', models.URLField(blank=True, null=True)),
                ('ts_stoptime', models.DateTimeField()),
                ('ts_stopfilelog', models.URLField(blank=True, null=True)),
                ('tn_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='testing_status', to='api.TestingNames')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pan_card', models.FileField(blank=True, null=True, upload_to='uploads/employee_docs/')),
                ('address_proof', models.FileField(blank=True, null=True, upload_to='uploads/employee_docs/')),
                ('permanent_proof', models.FileField(blank=True, null=True, upload_to='uploads/employee_docs/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_image', models.FileField(blank=True, null=True, upload_to='uploads/employee_docs/', validators=[api.employees.validators.validate_file_extension])),
                ('logout_image', models.FileField(blank=True, null=True, upload_to='uploads/employee_docs/', validators=[api.employees.validators.validate_file_extension])),
