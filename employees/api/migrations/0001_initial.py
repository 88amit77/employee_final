# Generated by Django 3.0.7 on 2020-07-24 13:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emp_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='empsalary', to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emp_id', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='employees.Employee')),
                ('leave_id', models.ManyToManyField(blank=True, null=True, to='employees.LeaveRules')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_by', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='action_by', to='employees.Employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ar_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='ar_attenadance_leaveids', to='employees.Attendence_rules')),
                ('emp_id', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
