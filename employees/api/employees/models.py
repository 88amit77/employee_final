...
class Documents(models.Model):
    ...
    pan_card = models.FileField(upload_to='uploads/employee_docs', max_upload_size=5242880, blank=True, null=True)
    address_proof = models.FileField(upload_to='uploads/employee_docs', max_upload_size=5242880,blank=True, null=True)
    permanent_proof = models.FileField(upload_to='uploads/employee_docs', max_upload_size=5242880,blank=True, null=True)
...
class Attendance(models.Model):
    ...
    Login_image = models.FileField(upload_to='uploads/employee_docs', max_upload_size=5242880, validators=[validate_file_extension],blank=True, null=True)
    Logout_image = models.FileField(upload_to='uploads/employee_docs',max_upload_size=5242880, validators=[validate_file_extension],blank=True, null=True)
