...
class ProcessMainid(models.Model):
	...
	main_attachment = models.FileField(blank=True, null=True, upload_to='dropbox/videos_main', max_length=100, validators=[FileExtensionValidator(allowed_extensions=['gif', 'mp4', 'png', 'jpeg', 'jpg'])])
...
class ProcessSubpoint(models.Model):
	...
	subpoint_attachment = models.FileField(blank=True, null=True, upload_to='dropbox/videos_subprocess', max_length=100, validators=[FileExtensionValidator(allowed_extensions=['gif', 'mp4', 'png', 'jpeg', 'jpg'])])
